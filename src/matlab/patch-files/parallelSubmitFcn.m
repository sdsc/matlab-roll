...
additionalSubmitArgs = sprintf('-A %s -l nodes=%d:ppn=%d -q %s -l walltime=%s -M %s@ucsd.edu -m abe', account,numberOfNodes, procsPerNode,queuename,time,username);
