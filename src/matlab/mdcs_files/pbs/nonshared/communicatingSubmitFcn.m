...
additionalSubmitArgs = sprintf('-l nodes=%d:ppn=%d,walltime=%s -q %s -A %s', numberOfNodes, procsPerNode,cluster.AdditionalProperties.Time,cluster.AdditionalProperties.Queue,cluster.AdditionalProperties.Aname);
