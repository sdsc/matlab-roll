...
for ii = 1:numberOfTasks
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    additionalSubmitArgs = sprintf('-l nodes=1:ppn=1,walltime=%s -q %s -A %s',cluster.AdditionalProperties.Time,cluster.AdditionalProperties.Queue,cluster.AdditionalProperties.Aname);
